...
/**
 ...
 A synchronized timestamp representing 'now' - use this if you need a current timestamp for other SnapscreenKit calls and don't want or can't use a SnapscreenTvSearchResultEntry.
